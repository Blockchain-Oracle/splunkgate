"""Aegis middleware config — frozen pydantic model.
...
class Config(BaseModel):
    """Frozen configuration for every Aegis middleware class."""
    ...
    ai_defense_api_key: SecretStr | None = Field(
        default=None,
        description="Cisco AI Defense API key. None when AEGIS_AI_DEFENSE_MOCK=1.",
    )
