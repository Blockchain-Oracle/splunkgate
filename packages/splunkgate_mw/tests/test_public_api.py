"""Public API contract tests for splunkgate_mw.
...
def test_all_four_middleware_classes_importable_from_top_level() -> None:
    """Each of the 4 middleware classes is reachable from `splunkgate_mw`."""
    for cls in MIDDLEWARE_CLASSES:
        assert cls.__module__.startswith("splunkgate_mw"), cls
...
def test_splunkgate_mw_version_is_set() -> None:
